...
aa = padarray(I,[ceil(max(rrange))+5 ceil(max(rrange))+5]);

ag = padarray(ag,[ceil(max(rrange))+5 ceil(max(rrange))+5]);

ngx = padarray(ngx,[ceil(max(rrange))+5 ceil(max(rrange))+5]);

ngy = padarray(ngy,[ceil(max(rrange))+5 ceil(max(rrange))+5]);
...
S=S(ceil(max(rrange))+5+1:end-ceil(max(rrange))-5,ceil(max(rrange))+1+5:end-ceil(max(rrange))-5,:,:);
